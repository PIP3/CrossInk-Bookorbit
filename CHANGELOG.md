...
- Reader clipping details no longer overlap navigation hints in landscape or upside-down orientations.
- File Browser once again honors its two-line display setting for longer file names.
